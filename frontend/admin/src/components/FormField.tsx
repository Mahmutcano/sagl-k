...
type DateFieldProps = Omit<InputHTMLAttributes<HTMLInputElement>, "type" | "id"> & {
  id: string;
  label: string;
  hint?: string;
  error?: string;
...
/** Date input with Basecoat input-group and calendar affordance. */
  ...
  return (
    <FormField id={id} label={label} hint={hint} error={error} className={fieldClassName}>
      <div className="input-group">
        <span data-align="inline-start" className="text-muted-foreground">
