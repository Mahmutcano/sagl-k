...
export function AuthShell({ children, badge = "Yönetim" }: AuthShellProps) {
  return (
    <div className="min-h-svh grid lg:grid-cols-2 bg-background text-foreground">
      <aside className="bg-primary text-primary-foreground relative hidden flex-col justify-between p-8 lg:flex xl:p-12">
        ...
        <div className="space-y-4 max-w-md">
          <h1 className="text-3xl font-semibold tracking-tight text-balance">Yönetim portalı</h1>
          <p className="text-primary-foreground/80 text-sm leading-relaxed">
            Hastaneler, başvurular ve Erciyes entegrasyonu gibi operasyonel işlemleri yönetin.
          </p>
        </div>
      </aside>
